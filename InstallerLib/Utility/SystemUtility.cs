...
namespace InstallerLib.Utility
{
    internal class SystemUtility
    {
        ...
        internal static void ExecuteProcess(string process, string args = "", string currentDirectory = "")
        {
        ...
        internal static void ExecuteProcessElevated(string process, string args = "", string currentDirectory = "")
        {
            var startInfo = new ProcessStartInfo(process, args);
